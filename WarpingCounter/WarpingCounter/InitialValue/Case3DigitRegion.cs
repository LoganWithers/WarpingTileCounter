namespace WarpingCounter.InitialValue
{
    ...
    public class Case3DigitRegion : AbstractTileNamer
    {
        ...
        private void CreateDigit1(string digit)
        {
            ...
            var digitTop1 = new DigitTop(Name(DigitTop + Seed, 1, region, true),
                                         L,
                                         new Glue($"{DigitTop} {1} {Seed} {region} {1}"),
            ...
            var returnPathDigit1Seed = new ReturnPathDigit1Seed(Name(ReturnPath + Seed, 1, region, true),
                                                                new Glue($"{ReturnPath} {1} {Seed} {region} {1}"),
            ...
            var nextReadDigit1Seed = new NextReadDigit1Seed(Name(NextRead + Seed, 1, region, true),
                                                            new Glue($"{NextRead} {1} {Seed} {region} {1}"),
        ...
        {
            var secondWarpDigit2 = new SecondWarpDigit2(Name(SecondWarp + Seed, 2, region, true), 
                                                        new Glue($"{SecondWarp} {2} {Seed} {region} {2}"),
                                                        new Glue($"{SecondWarp} {2} {Seed} {region} {2}"),
                                                        new Glue($"{PostWarp} {2} {Seed} {region} {2}"));
            Tiles.AddRange(secondWarpDigit2.Tiles);

            var postWarpDigit2 = new PostWarpDigit2(Name(PostWarp + Seed, 2, region, true),
                                                    new Glue($"{PostWarp} {2} {Seed} {region} {2}"),
                                                    new Glue($"{CounterWrite} {2} {Seed} {region} {2}"));

            Tiles.AddRange(postWarpDigit2.Tiles);

            var digit2 = new DigitWriter(Name(CounterWrite + Seed, 2, region, true), 
                                         digit,
                                         new Glue($"{CounterWrite} {2} {Seed} {region} {2}"),
            ...
            var digitTop2 = new DigitTop(Name(DigitTop + Seed, 2, region, true),
                                         L,
                                         new Glue($"{DigitTop} {2} {Seed} {region} {2}"),
                                         new Glue($"{ReturnPath} {2} {Seed} {region} {2}"));
            Tiles.AddRange(digitTop2.Tiles);

            var returnPath2 = new ReturnPathDigit2(Name(ReturnPath + Seed, 2, region, true),
                                                   L,
                                                   new Glue($"{ReturnPath} {2} {Seed} {region} {2}"),
                                                   new Glue($"{NextRead} {2} {Seed} {region} {2}"));
            Tiles.AddRange(returnPath2.Tiles);

            var nextRead2 = new NextReadDigit2Seed(Name(NextRead + Seed, 2, region, true),
                                                   L,
                                                   new Glue($"{NextRead} {2} {Seed} {region} {2}"),
        ...
        {
            var firstWarp3 = new FirstWarpDigit3(Name(FirstWarp + Seed, 3, region, op: true, msr: true, msd: true),
                                                 new Glue($"{FirstWarp} {3} {Seed} {region} {3}"),
                                                 new Glue($"{FirstWarp} {3} {Seed} {region} {3}"),
            ...
            var warpBridge3 = new WarpBridgeDigit3(Name(WarpBridge + Seed, 3, region, op: true, msr: true, msd: true),
                                                   new Glue($"{WarpBridge} {3} {Seed} {region} {3}"),
            ...
            var secondWarp3 = new SecondWarpDigit3(Name(SecondWarp + Seed,  3, region, op: true, msr: true, msd: true),
                                                   new Glue($"{SecondWarp} {3} {Seed} {region} {3}"),
                                                   new Glue($"{SecondWarp} {3} {Seed} {region} {3}"),
            ...
            var postWarp3 = new PostWarpDigit3(Name(PostWarp + Seed, 3, region, op: true, msr: true, msd: true),
                                               new Glue($"{PostWarp} {3} {Seed} {region} {3}"),
            ...
            var digit3 = new DigitWriter(Name(CounterWrite + Seed, 3, region, true), 
                                         digit,
                                         new Glue($"{CounterWrite} {3} {Seed} {region} {3}"),
            ...
            var digitTop3 = new DigitTop(Name(DigitTop + Seed, 3, region, op: true, msr: true, msd: true),
                                         L,
                                         new Glue($"{DigitTop} {3} {Seed} {region} {3}"),
            ...
            var returnPath3 = new ReturnPathDigit3(Name(ReturnPath + Seed, 3, region, op: true, msr: true, msd: true),
                                                   L,
                                                   new Glue($"{ReturnPath} {3} {Seed} {region} {3}"),
                                                   Bind(NextRead, 3, true, true, true));
