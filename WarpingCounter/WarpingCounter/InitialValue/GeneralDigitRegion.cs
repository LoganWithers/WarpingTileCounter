namespace WarpingCounter.InitialValue
{
    ...
    public class GeneralDigitRegion : AbstractTileNamer
    {
        ...
        {
            var firstWarp3 = new FirstWarpDigit3(Name(FirstWarp + Seed, 3, region, true),
                                                 new Glue($"{FirstWarp} {3} {Seed} {region} {3}"),
                                                 new Glue($"{FirstWarp} {3} {Seed} {region} {3}"),
            ...
            var warpBridge3 = new WarpBridgeDigit3(Name(WarpBridge + Seed, 3, region, true),
                                                   new Glue($"{WarpBridge} {3} {Seed} {region} {3}"),
            ...
            var secondWarp3 = new SecondWarpDigit3(Name(SecondWarp + Seed, 3, region, true),
                                                   new Glue($"{SecondWarp} {3} {Seed} {region} {3}"),
                                                   new Glue($"{SecondWarp} {3} {Seed} {region} {3}"),
            ...
            var postWarp3 = new PostWarpDigit3(Name(PostWarp + Seed, 3, region, true),
                                               new Glue($"{PostWarp} {3} {Seed} {region} {3}"),
            ...
            var digitTop3 = new DigitTop(Name(DigitTop + Seed, 3, region, true),
                                         L,
                                         new Glue($"{DigitTop} {3} {Seed} {region} {3}"),
