...
\begin{figure}[H]
    \centering
    \subcaptionbox{General \label{fig:cross_next_row}}
    {\makebox[0.24\textwidth][c]{\includegraphics[width=1in]{cross_next_row}}}%
    ~
    \subcaptionbox{General overview.
    ...
    {\makebox[0.30\textwidth][c]{\includegraphics[width=0.45in]{overviews/general/crosser}}}%
    ~
