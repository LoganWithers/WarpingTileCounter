...
\begin{itemize}
    ...
    \end{aligned}$\\ from the gadget in Figure~\ref{fig:return_from_2_op-or-seed}.
    ...
    \end{aligned}$\\from the gadget in Figure~\ref{fig:return_from_3}.
...
\begin{itemize}
    ...
    $\begin{aligned}[t]
            \returnfromdigit(&\left\langle \returnpath,    1, {\tt seed}, i \right\rangle,
                              \left\langle {\tt NextRead}, 1, {\tt seed}, i \right\rangle \;)
    \end{aligned}$\\from the general gadget shown in Figure~\ref{fig:return_from_1-or-2_op_msr_msd}
