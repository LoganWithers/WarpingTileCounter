...
\begin{figure}[H]
    ...
    ~
    \subcaptionbox{Digits in a general digit region \label{fig:counter_read_general}}
    {\makebox[0.24\textwidth][c]{\includegraphics[width=0.45in]{overviews/general/counter_read}}}%
    ~
\end{figure}
\begin{figure}[H]\ContinuedFloat
    \centering
    \subcaptionbox{Digit 2 in a case 2 digit region \label{fig:counter_read_case1}}
    {\makebox[0.24\textwidth][c]{\includegraphics[width=0.45in]{overviews/case1/counter_read_1_op_msr_msd}}}%
    ~
    \subcaptionbox{Digit 2 in a case 2 digit region \label{fig:counter_read_case2}}
