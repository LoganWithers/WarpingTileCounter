...
\begin{figure}[H]
    ...
    {\makebox[0.24\textwidth][c]{\includegraphics[width=0.33in]{counter_write_0}}}%
    ~
    \subcaptionbox{{\tt Counter\_Write\_1} \label{fig:counter_write_1}}
    {\makebox[0.24\textwidth][c]{\includegraphics[width=0.33in]{counter_write_1}}}%
    ~
    \subcaptionbox{Digits in a general digit region \label{fig:counter_write_i_op}}
    {\makebox[0.24\textwidth][c]{\includegraphics[width=0.45in]{overviews/general/counter_write_i_op}}}%
    ~
    \subcaptionbox{Digits in a general (seed) digit region \label{fig:counter_write_i_seed_op}}
...
\begin{figure}[H]\ContinuedFloat
    \centering
    \subcaptionbox{Digit 1 in a case 1 digit region \label{fig:counter_write_1_op_msr_msd}}
    {\makebox[0.24\textwidth][c]{\includegraphics[width=0.45in]{overviews/case1/counter_write_1_op_msr_msd}}}%
    ~
    \subcaptionbox{Digit 1 in a case 1 (seed) digit region \label{fig:counter_write_1_op_seed_msr_msd}}
    {\makebox[0.24\textwidth][c]{\includegraphics[width=0.45in]{overviews/case1/counter_write_1_seed_op_msr_msd}}}%
    ~
    \subcaptionbox{Digit 1 in a case 2 digit region \label{fig:counter_write_1_op_msr}}
    {\makebox[0.24\textwidth][c]{\includegraphics[width=0.45in]{overviews/case2/counter_write_1_op_msr}}}%
    ~
    \subcaptionbox{Digit 1 in a case 2 (seed) digit region \label{fig:counter_write_1_op_seed_msr}}
...
\begin{figure}[H]\ContinuedFloat
    \centering
    \subcaptionbox{Digit 2 in a case 2 digit region \label{fig:counter_write_2_op_msr_msd}}
    {\makebox[0.24\textwidth][c]{\includegraphics[width=0.45in]{overviews/case2/counter_write_2_op_msr_msd}}}%
    ~
    \subcaptionbox{Digit 2 in a case 2 (seed) digit region \label{fig:counter_write_2_op_seed_msr_msd}}
