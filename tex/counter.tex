...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.2\textwidth}
        \centering
        \includegraphics[width=.6in]{counter_read_start_general_case3_middle_level}
        \caption{\label{fig:counter_read_start_case3_middle_level} A ``clean'' counter row, before any reading has started.}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{0.2\textwidth}
        \centering
        \includegraphics[width=.6in]{counter_read_digit1_return_read_digit2_general_case3_middle_level}
    ...
    \begin{subfigure}[t]{0.2\textwidth}
        \centering
        \includegraphics[width=.6in]{counter_read_digit2_return_read_digit3_general_case3_middle_level}
    ...
    \begin{subfigure}[t]{0.2\textwidth}
        \centering
        \includegraphics[width=.6in]{counter_read_digit3_return_read_digit1_general_case3_middle_level}
