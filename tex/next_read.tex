...
\begin{figure}[H]\ContinuedFloat
    ...
    }{\makebox[0.32\textwidth][c]{\includegraphics[width=0.45in]{next_read_3_op-or-seed_msr_msd}}}%
    ~
    \subcaptionbox{
    ...
    }{\makebox[0.32\textwidth][c]{\includegraphics[width=0.45in]{overviews/case3/next_read_3_op_msr_msd}}}%
    ~
    \subcaptionbox{
        Digit 3 - case 3 (seed) overview.
        The black tiles in this figure correspond to the gadget shown in subfigure~\subref{fig:next_read_3_op-or-seed_msr_msd}.
        \label{fig:next_read_3_seed_op_msr_msd_overview}
    }{\makebox[0.32\textwidth][c]{\includegraphics[width=0.45in]{overviews/case3/next_read_3_seed_op_msr_msd}}}%
    ~
