...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \subcaptionbox{Digits 1, 2, \& 3 - general \label{fig:pre_warp_general}}
        {\makebox[0.24\textwidth][c]{\includegraphics[width=0.45in]{warping_pre_warp_general}}}%
        ~
        \subcaptionbox{Digit 1 - general\\overview\label{fig:pre_warp_1_op_overview}}
        {\makebox[0.24\textwidth][c]{\includegraphics[width=0.45in]{overviews/general/pre_warp_1_op}}}%
        ~
        \subcaptionbox{Digit 2 - general\\overview\label{fig:pre_warp_2_op_overview}}
        {\makebox[0.24\textwidth][c]{\includegraphics[width=0.45in]{overviews/general/pre_warp_2_op}}}%
        ~
        \subcaptionbox{Digit 3 - general\\overview\label{fig:pre_warp_3_op_overview}}
    ...
    \begin{figure}[H]
        \centering
        \subcaptionbox{Digit 1 - general\\ overview \label{fig:first_warp_1_op_overview}}
        {\makebox[0.24\textwidth][c]{\includegraphics[width=0.45in]{overviews/general/first_warp_1_op}}}%
        ~
        \subcaptionbox{Digit 2 - general\\ overview \label{fig:first_warp_2_op_overview}}
        {\makebox[0.24\textwidth][c]{\includegraphics[width=0.45in]{overviews/general/first_warp_2_op}}}%
        ~
        \subcaptionbox{Digit 3 - general\\ overview \label{fig:first_warp_3_op_overview}}
        {\makebox[0.24\textwidth][c]{\includegraphics[width=0.45in]{overviews/general/first_warp_3_op}}}%
        ~
        \subcaptionbox{Digit 3 - general (seed) overview \label{fig:first_warp_3_seed_op_overview}}
    ...
    \begin{figure}[H]\ContinuedFloat
        ...
        ~
        \subcaptionbox{Digit 3 - case 3 overview \label{fig:first_warp_3_op_msr_msd_overview}}
    ...
    \begin{figure}[H]\ContinuedFloat
        ...
        ~
        \subcaptionbox{Digit 2 - case 2 overview \label{fig:second_warp_2_op_msr_msd_overview}}
        ...
        ~
        \subcaptionbox{Digit 3 - case 3 overview \label{fig:second_warp_3_op_msr_msd_overview}}
    ...
    \begin{figure}[H]
        ...
        {\makebox[0.19\textwidth][c]{\includegraphics[width=0.45in]{warping_post_warp_general_digit1}}}%
        ~
        \subcaptionbox{Digit 1 - general\\overview. The black tiles in this figure is the gadget shown in subfigure~\subref{fig:post_warp_1_op}. }
        {\makebox[0.19\textwidth][c]{\includegraphics[width=0.45in]{overviews/general/post_warp_1_op}}}%
        ~
        \subcaptionbox{Digit 2 \& 3 - general\label{fig:post_warp_2or3_op}}
        {\makebox[0.19\textwidth][c]{\includegraphics[width=0.45in]{warping_post_warp_general_digit2and3}}}%
        ~
        \subcaptionbox{Digit 2 - general overview \label{fig:post_warp_2_op_overview}}
        {\makebox[0.19\textwidth][c]{\includegraphics[width=0.45in]{overviews/general/post_warp_2_op}}}%
        ~
        \subcaptionbox{Digit 3 - general overview \label{fig:post_warp_3_op_overview}}
        {\makebox[0.19\textwidth][c]{\includegraphics[width=0.45in]{overviews/general/post_warp_3_op}}}%
        ~
    \end{figure}
    \begin{figure}[H]\ContinuedFloat
        \centering
