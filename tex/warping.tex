...
all the way until the gadget can no longer continue assembling in the north direction.
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            ...
            {\makebox[0.24\textwidth][c]{\includegraphics[width=0.11\textwidth]{warping_pre_warp_general}}}%
            ~
        ...
        \begin{figure}[H]\ContinuedFloat
            ...
            {\makebox[0.24\textwidth][c]{\includegraphics[width=0.33in]{warping_pre_warp_case1_digit1_msr}}}%
            ~
        ...
        \begin{figure}[H]\ContinuedFloat
            ...
            {\makebox[0.24\textwidth][c]{\includegraphics[width=0.33in]{warping_pre_warp_case2_digit1_msr}}}%
            ~
            ...
            {\makebox[0.24\textwidth][c]{\includegraphics[width=0.33in]{warping_pre_warp_case2_digit2_msr}}}%
            ~
        ...
        \begin{figure}[H]
            ...
            {\makebox[0.11\textwidth][c]{\includegraphics[width=0.33in]{warping_warp_bridge_general}}}%
            ~
            \subcaptionbox{Digit 1 - general overview\label{fig:warp_bridge_1_op_overview}}
            {\makebox[0.19\textwidth][c]{\includegraphics[width=0.45in]{overviews/general/warp_bridge_1_op}}}%
            ~
            \subcaptionbox{Digit 2 - general overview\label{fig:warp_bridge_2_op_overview}}
            {\makebox[0.19\textwidth][c]{\includegraphics[width=0.45in]{overviews/general/warp_bridge_2_op}}}%
            ~
            \subcaptionbox{Digit 3 - general overview\label{fig:warp_bridge_3_op_overview}}
            {\makebox[0.19\textwidth][c]{\includegraphics[width=0.45in]{overviews/general/warp_bridge_3_op}}}%
            ~
        \end{figure}
        ...
        \begin{figure}[H]\ContinuedFloat
            ...
            {\makebox[0.19\textwidth][c]{\includegraphics[width=0.45in]{overviews/general/warp_bridge_2_seed_op}}}%
            ~
            \subcaptionbox{Digit 3 - general (seed) overview\label{fig:warp_bridge_3_seed_op_overview}}
            {\makebox[0.19\textwidth][c]{\includegraphics[width=0.45in]{overviews/general/warp_bridge_3_seed_op}}}%
            ~
            \subcaptionbox{Digit 2 \label{fig:warp_bridge_2_op_msr_msd}}
            {\makebox[0.11\textwidth][c]{\includegraphics[width=0.33in]{warping_warp_bridge_case2_digit2_msr}}}%
            ~
