...
\begin{flalign*}
      \text{Let }  m & = \ceil*{\left( \frac{N}{93} \right)^{\frac{1}{d}} } \text{, base of the counter} & \\
       ...
       \mathcal{C}_0 & = \text{starting value of counter}  \\
                   d & = \ceil*{\log_m({\mathcal{C}_0})},              \text{ number of digits per row }  \\
                \dr  & = \ceil*{\frac{d}{3}},                \text{ digit regions per row }           \\
     \mathcal{C}_{f} & = m^{d} - 1,                          \text{ final value of the counter} \\
\mathcal{C}_{\Delta} & = \mathcal{C}_f - \mathcal{C}_0,                          \text{ number of rows }            \\
